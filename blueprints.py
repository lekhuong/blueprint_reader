...
st.markdown("This AI allows you to upload engineering drawings and get a take-off of the quantities in markdown format.")
st.markdown("by Khuong Le Nguyen - lekhuong.jmi@gmail.com")
